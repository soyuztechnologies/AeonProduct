	...
	return app.listen(function () {
		...
		app.post('/getJobsWithCompany', function (req, res) {
			try {
				...
				let maxDate = payload.maxDate;
				let minDate = payload.minDate;
				...
				Job.find({
					...
					fields: {
					    ...
					    "jobCode": true,
					    "date": true,
					    "nameOFTheProduct": true,
					    "b-2-A": true,
					    "127Level3": true,
					    "13Level2": true,
					    "totalA+B": true,
					    "plateStatus": true,
					    "pantoneInksPart": true,
					    "pantoneInksPartStatus": true,
					    "foilBlocksPart": true,
					    "foilBlocksPartStatus": true,
					    "positivePart": true,
					    "positivePartStatus": true,
					    "embossBlockPart": true,
					    "embossBlockPartStatus": true,
					    "punchPart": true,
					    "punchPartStatus": true,
					    "varnish_Lamination": true,
					    "PoAttach": true
					},
